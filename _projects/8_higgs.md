...
**Scope of the study.** Higgs-portal dark matter models; existing constraints on invisible decays from [ATLAS](https://atlas.cern/) and [CMS](https://cms.cern/), principally through the vector-boson-fusion signature; and projected sensitivity at the HL-LHC.
