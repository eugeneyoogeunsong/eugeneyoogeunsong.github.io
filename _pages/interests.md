...
Underneath the four-letter code sits a stack of cognitive functions, and the pattern there is unambiguous: I am strongest by a distance on the intuition and thinking functions. My top three came out almost equally high, introverted intuition (Ni), extraverted thinking (Te) and introverted thinking (Ti), with extraverted intuition (Ne) moderate to high behind them. Extraverted sensing (Se) and introverted feeling (Fi) sit moderate, introverted sensing (Si) moderate to low, and extraverted feeling (Fe) lowest of the eight. Again, these are more for fun than for serious interpretation.
