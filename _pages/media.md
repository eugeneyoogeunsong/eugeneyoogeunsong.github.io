...
<style>
  /* Scoped to this page. al-folio v1.x ships with Bootstrap compat disabled,
     so .row and col-* are undefined — everything here is self-contained CSS
     built on the theme's own custom properties, so dark mode follows along. */
  ...
  .mo-outlet {
    /* A label on a card, not a button: quiet accent. White on #312e81 is 11:1. */
    background: var(--local-accent-deep, #312e81);
    color: #fff;
  ...
  .mo-links { display: flex; flex-wrap: wrap; gap: 0.45rem; }
  .mo-links a {
    font-size: 0.8rem;
  ...
  @media (max-width: 576px) {
    .mo-stat b { font-size: 1.45rem; }
    .mo-scan img { height: 180px; }
  }
</style>
...
{% include banner.liquid src="/assets/img/london/thames-full.jpg" alt="The Thames from above at dusk, Tower Bridge in the foreground and Canary Wharf beyond" w="1500" h="1000" caption="Based in London since 2023, and working with English-language outlets from 2026." %}
...
<div class="mo-stats">
  ...
  <div class="mo-stat"><b><a href="https://www.linkedin.com/in/yoogeunsong" target="_blank" rel="noopener">{{ site.linkedin_followers }}</a></b><span>LinkedIn followers</span></div>
</div>
...
<div class="mo-grid">
  ...
  <div class="mo-card">
    <div class="mo-card-body">
      <div class="mo-meta"><span class="mo-outlet">KBS</span><span>January &amp; June 2005</span></div>
      <h3>Screening Humanity (인간극장)</h3>
      <p>Two five-episode documentary series following my life through elementary and high school.</p>
      <div class="mo-links">
...
<div class="mo-grid">
  ...
  <div class="mo-card">
    <a class="mo-scan" href="{{ '/assets/pdf/korea-herald-2005-physics-genius-enters-university.pdf' | relative_url }}" target="_blank" rel="noopener">
      <img src="{{ '/assets/img/media/korea-herald-2005.jpg' | relative_url }}" alt="The Korea Herald front page, November 2005" loading="lazy">
    </a>
    <div class="mo-card-body">
