...
My research has moved across general relativity, cosmology, high-energy astrophysics, particle physics, machine learning, quantum computing and quantitative finance. That looks like a scattered CV until you notice that every one of those problems is the same problem: **you have noisy, incomplete data generated by a physical process you only partly understand, and you need a calibrated statement about what is true.** Everything below is a variation on that.
