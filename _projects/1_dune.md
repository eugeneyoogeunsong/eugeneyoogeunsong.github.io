...
**Where I actually am.** London, not Illinois or South Dakota. The beamline and the caverns are in the United States; the analysis is not tied to them. Simulation, fits, framework development and review all run on shared computing, so the work I do (statistical modelling, inference, reconstruction) happens from Imperial's South Kensington campus, with travel to Fermilab for collaboration meetings rather than residence there.
