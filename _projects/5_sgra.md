...
**Method.** General-relativistic magnetohydrodynamic simulations run in **BHAC**, post-processed through general-relativistic radiative transfer in **BHOSS**, in Fortran and Python.
